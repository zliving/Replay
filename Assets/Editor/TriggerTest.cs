...
public class TriggerTest {
	...
	[Test]
	public void TriggerContoller_isPlayerOnTriggerEntered_True() {
	...
	[Test]
	public void TriggerController_isPlayerOnTriggerEntered_False() {
		// Create trigger object
		GameObject trigger = GameObject.CreatePrimitive(PrimitiveType.Cube);
		trigger.AddComponent<CounterTrigger> ();
		CounterTrigger counterTrigger = trigger.GetComponent<CounterTrigger> ();
	...
	[Test]
	public void TriggerController_isPlayerOnTriggerExit_False() {
		// Create trigger object
		GameObject trigger = GameObject.CreatePrimitive(PrimitiveType.Cube);
		trigger.AddComponent<CounterTrigger> ();
		CounterTrigger counterTrigger = trigger.GetComponent<CounterTrigger> ();
		...
		// Call the event trigger
		counterTrigger.OnTriggerExit (c);
